...
const LoginForm: React.FC = (props) => {
    ...
    const renderUserNameField = () =>{
        return (
            ...
            <input type="text" placeholder="Username" onChange={onChangeUsername} value={username} id="username"/>
            </>  
        )
    }
    ...
    const renderPasswordField = () =>{
        return (
            ...
            <input type="password" placeholder="Password" onChange={onChangePassword} value={password} id='password'/>
            </>         
        )
    }
    ...
    <div className='login-container'> 
        <div className='login-form-container'> 
            <form onSubmit = {onSubmitForm} className='login-form'>
                ...
                <div className='login-button-container'><button type="submit" className='login-button'>Login</button> </div>
